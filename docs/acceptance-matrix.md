...
| REL-007 | 部分通过 | Ubuntu 24.04 [`ci` run 31189601927](https://github.com/sshiong/frp-panel-platform-v3/actions/runs/31189601927) 的 disposable 32MiB tmpfs 真实填满文件系统，验证 Router 原子写失败不覆盖 last-good；备份/恢复和目标部署磁盘演练仍待外部。 |
