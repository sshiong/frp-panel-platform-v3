...
当前 revision 证据：`acff39332c04adfe975522a8b58831186866ef91` 的 CI
run `31337118973` 与 CodeQL run `31337118979` 均成功；同 revision 的
`make external-acceptance` 报告为 9 passed / 0 failed / 1 blocked。阻断项
仍严格限于真实 Provider、目标环境、正式签名和负责人签字，不改变下方
逐项状态的外部证据要求。
