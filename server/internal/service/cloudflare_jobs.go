...
func writeAtomicPrivate(path string, content []byte) error {
	...
	file, err := os.OpenFile(tmp, os.O_CREATE|os.O_WRONLY|os.O_TRUNC, 0o600) // #nosec G304 -- temporary certificate path is generated under the configured data directory
	if err != nil {
		return err
	}
