...
| 2026-08-09 | npm 高危 advisory 修复 | 已修复并待托管复核；Admin/Client lockfile 的 `nanoid` 从 3.3.16 更新至 3.3.18，两个面板本地 `npm ci` 与 npmjs registry `npm audit --audit-level=high` 均报告 0 vulnerabilities |
